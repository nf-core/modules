...
include { JUPYTERNOTEBOOK } from '../../../modules/jupyternotebook/main.nf' addParams( parametrize: false, options: [:] )
include { JUPYTERNOTEBOOK as JUPYTERNOTEBOOK_PARAMETRIZE } from '../../../modules/jupyternotebook/main.nf' addParams( options: [:] )
include { JUPYTERNOTEBOOK as JUPYTERNOTEBOOK_PARAMETRIZE_IPYNB } from '../../../modules/jupyternotebook/main.nf' addParams( options: [:] )
