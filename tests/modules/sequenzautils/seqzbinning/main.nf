...
workflow test_sequenzautils_seqzbinning {
    ...
    normalbam = file(params.test_data['homo_sapiens']['illumina']['test_paired_end_sorted_bam'], checkIfExists: true)
    fasta = file(params.test_data['homo_sapiens']['genome']['genome_fasta'], checkIfExists: true)

    input_gcwiggle = [ [ id:'test' ], fasta ]
    SEQUENZAUTILS_GCWIGGLE(input_gcwiggle)

    input_bam2seqz = [ [ id:'test' ], tumourbam, tumourbam ]
    SEQUENZAUTILS_BAM2SEQZ ( input_bam2seqz, fasta, SEQUENZAUTILS_GCWIGGLE.out[0][1] )
