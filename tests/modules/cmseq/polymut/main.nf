...
include { CMSEQ_POLYMUT as CMSEQ_POLYMUT_TEST1 ; CMSEQ_POLYMUT as CMSEQ_POLYMUT_TEST2 ; CMSEQ_POLYMUT as CMSEQ_POLYMUT_TEST3 } from '../../../../modules/cmseq/polymut/main.nf' addParams( options: [:] )
