...
include { SENTIEON_VARCAL } from '../../../../../modules/nf-core/sentieon/varcal/main.nf'

workflow test_sentieon_varcal {
    ...
    SENTIEON_VARCAL(input, resources_vcf, resources_tbi, labels, fasta, fai)
}
