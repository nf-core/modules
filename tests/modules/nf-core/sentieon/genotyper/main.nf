...
include { SENTIEON_JOINT_GENOTYPING } from '../../../../../modules/nf-core/sentieon/genotyper/main.nf'
include { UNTAR                     } from '../../../../../modules/nf-core/untar/main.nf'

// Basic parameters with uncompressed VCF input
workflow test_sentieon_genotyper_vcf_input {
    ...
    SENTIEON_JOINT_GENOTYPING( input, fasta, fai, [], [])
}

// Basic parameters with compressed VCF input
workflow test_sentieon_genotyper_gz_input {
...
workflow test_sentieon_genotyper_gz_input_dbsnp {
    ...
    SENTIEON_JOINT_GENOTYPING( input, fasta, fai, dbsnp, dbsnp_tbi)
}

// Basic parameters + optional intervals
workflow test_sentieon_genotyper_gz_input_intervals {
...
workflow test_sentieon_genotyper_gz_input_dbsnp_intervals {
