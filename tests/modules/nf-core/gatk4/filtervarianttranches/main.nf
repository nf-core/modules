...
include { GATK4_FILTERVARIANTTRANCHES } from "$moduleDir/modules/nf-core/gatk4/filtervarianttranches/main.nf"
include { GATK4_CNNSCOREVARIANTS } from "$moduleDir/modules/nf-core/gatk4/cnnscorevariants/main.nf"
include { GATK4_HAPLOTYPECALLER  } from "$moduleDir/modules/nf-core/gatk4/haplotypecaller/main.nf"
