...
include { METAPHLAN3                      } from "$moduleDir/modules/nf-core/metaphlan3/metaphlan3/main.nf"
include { METAPHLAN3_MERGEMETAPHLANTABLES } from "$moduleDir/modules/nf-core/metaphlan3/mergemetaphlantables/main.nf"
