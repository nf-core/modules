...
include { ASCAT as ASCAT_SIMPLE }            from "$moduleDir/modules/nf-core/ascat/main.nf"
include { ASCAT as ASCAT_PLOIDY_AND_PURITY } from "$moduleDir/modules/nf-core/ascat/main.nf"
include { ASCAT as ASCAT_CRAM }              from "$moduleDir/modules/nf-core/ascat/main.nf"
include { UNZIP as UNZIP_ALLELES }           from "$moduleDir/modules/nf-core/unzip/main.nf"
include { UNZIP as UNZIP_LOCI }              from "$moduleDir/modules/nf-core/unzip/main.nf"
include { UNZIP as UNZIP_GC }                from "$moduleDir/modules/nf-core/unzip/main.nf"
include { UNZIP as UNZIP_RT }                from "$moduleDir/modules/nf-core/unzip/main.nf"
