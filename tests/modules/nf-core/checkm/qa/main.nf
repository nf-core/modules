...
include { CHECKM_QA                     } from "$moduleDir/modules/nf-core/checkm/qa/main.nf"
include { CHECKM_QA as CHECKM_QA_FASTA  } from "$moduleDir/modules/nf-core/checkm/qa/main.nf"
