...
include { MULTIQC                     } from "$moduleDir/modules/nf-core/multiqc/main.nf"
include { CUSTOM_DUMPSOFTWAREVERSIONS } from "$moduleDir/modules/nf-core/custom/dumpsoftwareversions/main.nf"
