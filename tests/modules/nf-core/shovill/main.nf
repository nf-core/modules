...
include { SHOVILL as SHOVILL_MEGAHIT } from "$moduleDir/modules/nf-core/shovill/main.nf"
include { SHOVILL as SHOVILL_VELVET  } from "$moduleDir/modules/nf-core/shovill/main.nf"
