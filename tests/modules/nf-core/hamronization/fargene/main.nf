...
include { FARGENE               } from "$moduleDir/modules/nf-core/fargene/main.nf"
include { HAMRONIZATION_FARGENE } from "$moduleDir/modules/nf-core/hamronization/fargene/main.nf"
