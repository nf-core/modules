...
include { DIAMOND_BLASTX } from "$moduleDir/modules/nf-core/diamond/blastx/main.nf"
include { MEGAN_DAA2INFO } from "$moduleDir/modules/nf-core/megan/daa2info/main.nf"
