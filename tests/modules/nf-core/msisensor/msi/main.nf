...
include { MSISENSOR_SCAN } from "$moduleDir/modules/nf-core/msisensor/scan/main.nf"
include { MSISENSOR_MSI } from "$moduleDir/modules/nf-core/msisensor/msi/main.nf"
