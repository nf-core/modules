...
include { CENTRIFUGE_CENTRIFUGE } from "$moduleDir/modules/nf-core/centrifuge/centrifuge/main.nf"
include { CENTRIFUGE_KREPORT    } from "$moduleDir/modules/nf-core/centrifuge/kreport/main.nf"
