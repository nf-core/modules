...
include { ENTREZDIRECT_ESEARCH as ENTREZDIRECT_ESEARCHP  } from "$moduleDir/modules/entrezdirect/esearch/main.nf"
include { ENTREZDIRECT_ESEARCH                           } from "$moduleDir/modules/entrezdirect/esearch/main.nf"
