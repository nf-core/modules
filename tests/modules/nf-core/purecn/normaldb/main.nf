...
workflow test_purecn_normaldb_normalvcf {
    ...
    input  = [
        ...
        [file('https://raw.githubusercontent.com/lima1/PureCN/master/inst/extdata/example_normal.txt.gz', checkIfExists: true),
        file('https://raw.githubusercontent.com/lima1/PureCN/master/inst/extdata/example_normal2.txt.gz', checkIfExists: true)],
        [vcf: file('https://raw.githubusercontent.com/lima1/PureCN/master/inst/extdata/example_normal.vcf.gz', checkIfExists: true),
        tbi: file('https://raw.githubusercontent.com/lima1/PureCN/master/inst/extdata/example_normal.vcf.gz.tbi', checkIfExists: true)]
    ]
    genome = 'hg38'
    assay  = 'illumina'
