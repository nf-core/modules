...
include { KRAKEN2_KRAKEN2 } from "$moduleDir/modules/nf-core/kraken2/kraken2/main"
include { KRAKENTOOLS_COMBINEKREPORTS } from "$moduleDir/modules/nf-core/krakentools/combinekreports/main.nf"
