...
include { BAM_VARIANT_CALLING_SOMATIC_MUTECT2 } from '../../../../subworkflows/nf-core/bam_variant_calling_somatic_mutect2/main'
...
workflow test_bam_variant_calling_somatic_mutect2 {
    ...
    fai   = Channel.value([[ id:'genome' ], file(params.test_data['homo_sapiens']['genome']['genome_21_fasta_fai'],                checkIfExists: true)])
    ...
    BAM_VARIANT_CALLING_SOMATIC_MUTECT2 ( input, fasta, fai, dict, germline_resource, germline_resource_tbi, panel_of_normals, panel_of_normals_tbi, interval_file, joint_mutect2 )
}
