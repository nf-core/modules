...
workflow test_gatk_tumor_only_somatic_variant_calling {
    ...
    GATK_TUMOR_ONLY_SOMATIC_VARIANT_CALLING ( ch_mutect2_in, fasta, fastaidx, dict, germline_resource, germline_resource_idx, panel_of_normals, panel_of_normals_idx, interval_file )
}
