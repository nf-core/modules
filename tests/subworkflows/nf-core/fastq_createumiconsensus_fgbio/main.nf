...
workflow test_fastq_createumiconsensus_fgbio_single_umi {
    ...
    FASTQ_CREATEUMICONSENSUS_FGBIO ( reads, fasta, false, dict, "Adjacency", "bwa-mem", false )
}
...
workflow test_fastq_createumiconsensus_fgbio_duplex_umi {
    ...
    FASTQ_CREATEUMICONSENSUS_FGBIO ( reads, fasta, false, dict, "paired", "bwa-mem", true )
}
