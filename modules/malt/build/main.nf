...
process MALT_BUILD {
    ...
    // Do not **auto-bump** due to problem with change of version numbering between 0.4.1 and 0.5.2 (originaly 0.4.1 was listed as 0.41, so is always selected as 'latest' even though it is
