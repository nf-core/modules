process VCFTOOLS {
    ...
    args_list.removeIf { it -> it.contains('--bed') }
    args_list.removeIf { it -> it.contains('--exclude-bed') }
    args_list.removeIf { it -> it.contains('--hapcount') }
    args_list.removeIf { it -> it.contains('--positions') }
    args_list.removeIf { it -> it.contains('--exclude-positions') }
    ...
    args_list.removeIf { it -> it.contains('--diff') }
    args_list.removeIf { it -> it.contains('--gzdiff') }
    args_list.removeIf { it -> it.contains('--diff-bcf') }
