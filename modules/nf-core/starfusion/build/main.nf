process STARFUSION_BUILD {
    ...
    echo | gzip > ctat_genome_lib_build_dir/blast_pairs.dat.gz
    ...
    echo | gzip > ctat_genome_lib_build_dir/fusion_annot_lib.gz
    touch ctat_genome_lib_build_dir/fusion_annot_lib.idx
    touch ctat_genome_lib_build_dir/pfam_domains.dbm
    echo | gzip > ctat_genome_lib_build_dir/PFAM.domtblout.dat.gz
    ...
    echo | gzip > ctat_genome_lib_build_dir/trans.blast.dat.gz
