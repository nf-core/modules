...
process SHINYNGS_APP {
    ...
    conda "bioconda::r-shinyngs=1.6.1"
    container "${ workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/r-shinyngs:1.6.1--r42hdfd78af_0':
        'quay.io/biocontainers/r-shinyngs:1.6.1--r42hdfd78af_0' }"
