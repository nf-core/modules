...
process JUPYTERNOTEBOOK {
    ...
    conda (params.enable_conda ? "conda-forge::ipykernel=6.0.3 conda-forge::jupytext=1.11.4 conda-forge::nbconvert=6.1.0 conda-forge::papermill=2.3.3 conda-forge::matplotlib=3.4.2" : null)
