process DEEPVARIANT_MAKEEXAMPLES {
    ...
    tuple val("${task.process}"), val('deepvariant_makeexamples'), eval("/opt/deepvariant/bin/run_deepvariant --version | sed 's/^.*version //'"), topic: versions, emit: versions_deepvariant_makeexamples
