process LDAK_REML {
    ...
    output:
    tuple val(meta), path("${meta.id}.reml"), emit: reml_results
    ...
    tuple val(meta), path("${meta.id}.indi.blp"), emit: indi_blp, optional: true
    tuple val(meta), path("${meta.id}.indi.res"), emit: indi_res, optional: true
    ...
    tuple val(meta), path("${meta.id}.vars"), emit: vars, optional: true
    ...
    touch ${meta.id}.cross
    touch ${meta.id}.indi.blp
    touch ${meta.id}.indi.res
