process ENDORSPY {
    ...
    if (stats_qualityfiltered && !stats_raw && !stats_deduplicated) {
        error("ERROR: only input channel stats_qualityfiltered provided. No stats can be calculated. Add at least one additional input channel: stats_raw or stats_deduplicated")
    }
