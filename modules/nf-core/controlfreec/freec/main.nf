process CONTROLFREEC_FREEC {
    ...
    def mappability_command         = mappability                                         ? "gemMappabilityFile = \${PWD}/${mappability}" : ""
    ...
    def minipileup_normal_command   = minipileup_normal                                   ? "miniPileup = \${PWD}/${minipileup_normal}" : ""
    ...
    def minipileup_tumor_command    = minipileup_tumor                                    ? "miniPileup = \${PWD}/${minipileup_tumor}" : ""
    ...
    echo ${mappability_command} >> config.txt
    ...
    echo ${minipileup_normal_command} >> config.txt
    ...
    echo ${minipileup_tumor_command} >> config.txt
    ...
    echo ${target_bed_command} >> config.txt
