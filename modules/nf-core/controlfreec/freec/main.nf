process CONTROLFREEC_FREEC {
    ...
    def mappability_var = mappability ? "gemMappabilityFile = \${PWD}/${mappability}" : ""
    ...
    def minipileup_normal_var = minipileup_normal ? "miniPileup = \${PWD}/${minipileup_normal}" : ""
    ...
    def minipileup_tumor_var = minipileup_tumor ? "miniPileup = \${PWD}/${minipileup_tumor}" : ""
    ...
    def target_bed_var = target_bed ? "captureRegions = ${target_bed}" : ""
    ...
    echo ${mappability_var} >> config.txt
    ...
    echo ${minipileup_normal_var} >> config.txt
    ...
    echo ${minipileup_tumor_var} >> config.txt
    ...
    echo ${target_bed_var} >> config.txt
