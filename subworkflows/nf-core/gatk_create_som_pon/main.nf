...
include { GATK4_MUTECT2                     } from "$moduleDir/modules/nf-core/gatk4/mutect2/main"
include { GATK4_GENOMICSDBIMPORT            } from "$moduleDir/modules/nf-core/gatk4/genomicsdbimport/main"
include { GATK4_CREATESOMATICPANELOFNORMALS } from "$moduleDir/modules/nf-core/gatk4/createsomaticpanelofnormals/main"
