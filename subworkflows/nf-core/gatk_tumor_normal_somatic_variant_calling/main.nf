...
include { GATK4_MUTECT2                   as MUTECT2 }                   from '../../../modules/nf-core/gatk4/mutect2/main'                   addParams( options: params.mutect2_options )
include { GATK4_LEARNREADORIENTATIONMODEL as LEARNREADORIENTATIONMODEL } from '../../../modules/nf-core/gatk4/learnreadorientationmodel/main' addParams( options: params.learnorientation_options )
include { GATK4_GETPILEUPSUMMARIES        as GETPILEUPSUMMARIES_TUMOR }  from '../../../modules/nf-core/gatk4/getpileupsummaries/main'        addParams( options: params.getpileup_tumor_options )
include { GATK4_GETPILEUPSUMMARIES        as GETPILEUPSUMMARIES_NORMAL}  from '../../../modules/nf-core/gatk4/getpileupsummaries/main'        addParams( options: params.getpileup_normal_options )
...
include { GATK4_FILTERMUTECTCALLS         as FILTERMUTECTCALLS }         from '../../../modules/nf-core/gatk4/filtermutectcalls/main'         addParams( options: params.filtercalls_options )
