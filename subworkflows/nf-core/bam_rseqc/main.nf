...
include { RSEQC_BAMSTAT            } from "$moduleDir/modules/nf-core/rseqc/bamstat/main"
include { RSEQC_INNERDISTANCE      } from "$moduleDir/modules/nf-core/rseqc/innerdistance/main"
include { RSEQC_INFEREXPERIMENT    } from "$moduleDir/modules/nf-core/rseqc/inferexperiment/main"
include { RSEQC_JUNCTIONANNOTATION } from "$moduleDir/modules/nf-core/rseqc/junctionannotation/main"
include { RSEQC_JUNCTIONSATURATION } from "$moduleDir/modules/nf-core/rseqc/junctionsaturation/main"
include { RSEQC_READDISTRIBUTION   } from "$moduleDir/modules/nf-core/rseqc/readdistribution/main"
include { RSEQC_READDUPLICATION    } from "$moduleDir/modules/nf-core/rseqc/readduplication/main"
include { RSEQC_TIN                } from "$moduleDir/modules/nf-core/rseqc/tin/main"
