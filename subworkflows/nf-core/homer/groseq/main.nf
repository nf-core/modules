...
include { HOMER_MAKETAGDIRECTORY } from "$moduleDir/modules/nf-core/homer/maketagdirectory/main"
include { HOMER_MAKEUCSCFILE     } from "$moduleDir/modules/nf-core/homer/makeucscfile/main"
include { HOMER_FINDPEAKS        } from "$moduleDir/modules/nf-core/homer/findpeaks/main"
include { HOMER_POS2BED          } from "$moduleDir/modules/nf-core/homer/pos2bed/main"
