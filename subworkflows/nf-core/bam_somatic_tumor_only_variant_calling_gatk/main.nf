...
workflow BAM_TUMOR_ONLY_SOMATIC_VARIANT_CALLING_GATK  {
    ...
    ch_germline_resource_pileup     = ch_germline_resource_tbi ? ch_germline_resource : Channel.empty()
    ch_germline_resource_pileup_tbi = ch_germline_resource_tbi ?: Channel.empty()
