include { CUSTOM_SRATOOLSNCBISETTINGS } from "$moduleDir/modules/nf-core/custom/sratoolsncbisettings/main"
include { SRATOOLS_PREFETCH           } from "$moduleDir/modules/nf-core/sratools/prefetch/main"
include { SRATOOLS_FASTERQDUMP        } from "$moduleDir/modules/nf-core/sratools/fasterqdump/main"
