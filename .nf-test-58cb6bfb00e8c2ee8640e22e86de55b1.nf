...
workflow {
    ...
    def input = []
                ...
                input[0] = [
                    ...
                    file("/Users/olga/code/nf-core/modules/modules/nf-core/interproscan/tests/../tests/fixtures/test.fasta", checkIfExists: true)
                ]
                input[1] = [
                    file("/Users/olga/code/nf-core/modules/modules/nf-core/interproscan/tests/../tests/fixtures/interproscan_db/data", type: 'dir', checkIfExists: true),
                    "5.73-104.0"
                ]
